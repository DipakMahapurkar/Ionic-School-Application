...
export class HomePage {
    ...
    constructor(public navCtrl: NavController,
        ...
        this.dashboardMenus = [
            ...
            { "id": 6, menuName: "Timetable", image: "assets/img/notice.png" },
            { "id": 7, menuName: "Notice", image: "assets/img/application.png" },
            { "id": 8, menuName: "Application", image: "assets/img/about_image.png" },
        ];
    }
